...
<body>
    ...
    <!-- ini end modal -->
        ...
        <form id="myform" method="post" action="update_skills.php">
            ...
            <div class="form-group">
                <label>HTML</label>
                <input id="html" class="form-control" type="text" name="html" value="<?php echo $html ?>" <?php echo $disableForm ?> >
            </div>
            <div class="form-group">
                <label>CSS</label>
                <input id="css" class="form-control" type="text" name="css" value="<?php echo $css ?>" <?php echo $disableForm ?> >
            </div>
            <div class="form-group">
                <label>PHP</label>
                <input id="php" class="form-control" type="text" name="php" value="<?php echo $php ?>" <?php echo $disableForm ?> >
            </div>           
            <div class="form-group">
                <label>Microsoft</label>
                <input id="ms" class="form-control" type="text" name="ms" value="<?php echo $ms ?>" <?php echo $disableForm ?> >
            </div>   
            <div class="form-group">
                <label>Teamwork</label>
                <input id="tm" class="form-control" type="text" name="tm" value="<?php echo $tm ?>" <?php echo $disableForm ?> >
            </div>   
            <div class="form-group">
                <label>Public Speaking</label>
                <input id="ps" class="form-control" type="text" name="ps" value="<?php echo $ps ?>" <?php echo $disableForm ?> >
            </div>   
